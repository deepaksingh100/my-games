 ...
 * @author SONY
 */
public class SpeedMenu1 extends javax.swing.JFrame{
public SpeedMenu1() {
    ...
    private void initComponents() {
        ...
        jLabel2.setBounds(180, 40, 246, 40);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SpeedMenu1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
