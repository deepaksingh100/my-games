...
public class Stage4 extends JFrame implements Runnable
{
	JFrame f;
	JPanel p;
	JLabel l,l1,l2,l3;
	int w=595,h=619,x=280,y=100,sw,sh,w1,h1,sco,q=0,hs;
	Timer t;
        Thread th1;
        int v=5;
        boolean bo=false;
	...
	int y9[]=new int[12];
	int z;
	public Stage4(final int n,int o)
	{
		super("Snake Game::STAGE-4");
                file.mkdirs();
                file.setReadOnly();
                //f1.setReadOnly();
		...
		for(int i=0;i<12;i++)
		{
			...
			p.add(larr8[i]);
               ...
               for(int i=0;i<28;i++)
		{
			while((w1==x2[i]&&h1==y2[i])||(w1==x3[i]&&h1==y3[i])||(w1==x4[i]&&h1==y4[i])||(w1==x5[i]&&h1==y5[i]))
			{
                    ...
                    bo=true;}
                        ...
                        try{
			                URL url=getClass().getResource("wind3.wav");
                                        ...
                                        {}
				w1=(20*(int)(17*Math.random()+1));
				h1=(20*(int)(22*Math.random()+1));
				if(v==31)
				{
					t.stop();
					try{
			                URL url=getClass().getResource("wind.wav");
                                        ...
                                        {}
					JOptionPane.showMessageDialog(null,"Congrates,You Win, Your Score is "+sco+" !!!");
                                        if(bo){
                                            Toolkit.getDefaultToolkit().beep();
                                        JOptionPane.showMessageDialog(null,"Now You Are Snake Master,\nHighest Score is  "+sco+" !!!");
                                        }
                                        Toolkit.getDefaultToolkit().beep();
					int opt=JOptionPane.showOptionDialog(f,"Go To Main Menu???","Question",JOptionPane.YES_NO_OPTION,JOptionPane.QUESTION_MESSAGE,null,null,null);
					if(opt==0)
					{
                                                new MainMenu().setVisible(true);
						f.dispose();
				...
				for(int i=0;i<v;i++)
				{
					if(w1==x1[i]&&h1==y1[i])
					{
			                ...
			                URL url=getClass().getResource("wind3.wav");
                                        ...
                                        {}
						w1=(20*(int)(17*Math.random()));
						h1=(20*(int)(22*Math.random()));
						i=0;
					}
