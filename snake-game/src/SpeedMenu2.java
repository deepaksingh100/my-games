 ...
 * @author SONY
 */
public class SpeedMenu2 extends javax.swing.JFrame{
public SpeedMenu2() {
...
@SuppressWarnings("unchecked")
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
          int n=100;
        new Stage2(n,0).setVisible(true);
        this.dispose();
        // TODO add your handling code here:
  ...
  new Stage2(n,0).setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SpeedMenu2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
