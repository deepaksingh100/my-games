 ...
 * @author SONY
 */
public class SpeedMenu4 extends javax.swing.JFrame{
public SpeedMenu4() {
 ...
 int n=100;
        new Stage4(n,0).setVisible(true);
 ...
 int n=60;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SpeedMenu4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
